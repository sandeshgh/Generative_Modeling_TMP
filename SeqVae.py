...
class VAE(nn.Module):
    ...
    def decode(self, z):
        ...
        out,hidden=self.fc5(self.fc4(h3))
...
def loss_function(recon_x, x, mu, logvar):
    ...
    BCE/=(batch_size * input_dim*seq_length/1.443)
