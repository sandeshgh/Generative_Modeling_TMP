...
if modelStructure=='SeqGauss':
    ...
    model = VAEGauss()
    modelfull=torch.load('output/modelGaussAn500', map_location={'cuda:0': 'cpu'})
    ...
    #print(reconstruct)
    M=reconstruct.data.resize_(input_dim,seq_length)
    #M=V.resize_(seq_length,input_dim)
    #print('V is ',V)
    #print('M is', M)
    #M=V
    plotMatrix(M.permute(1,0), seq_length, 5)
